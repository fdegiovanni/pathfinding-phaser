        ...
        switch (_b.label) {
          case 0:
            ...
            (_a = this.heapArray).push.apply(
              _a,
              __spreadArray$1([], __read$1(elements), false)
            );
            l = this.length;
            _b.label = 1;
          case 1:
    ...
    return __awaiter(this, void 0, void 0, function () {
      return __generator$1(this, function (_a) {
        if (this.heapArray.length === 0 || n <= 0) {
          ...
          return [
            2 /*return*/,
            __spreadArray$1([], __read$1(this.heapArray), false),
          ];
        } else {
          // Some elements
      ...
      return __generator$1(this, function (_b) {
        switch (_b.label) {
          ...
          case 2:
            ...
            (children_1 = ((e_1 = void 0), __values(children))),
      ...
      return __generator$1(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            (_a = __read$1([this.heapArray[0], element], 2)),
              (element = _a[0]),
      ...
      return __generator$1(this, function (_b) {
        switch (_b.label) {
                ...
                return __generator$1(this, function (_b) {
                  switch (_b.label) {
                    case 0:
                      ...
                      return [
                        4 /*yield*/,
                        this.compare(this.heapArray[j], this.heapArray[best]),
                      ];
                    case 1:
                      _a = _b.sent() < 0;
                      _b.label = 2;
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              getPotentialParent(bestChildIndex, childrenIdx[j]),
            ];
          case 3:
      ...
      return __generator$1(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.compare(this.heapArray[pi], this.heapArray[i]),
            ];
          case 2:
            _a = _b.sent() > 0;
            _b.label = 3;
        ...
        switch (_a.label) {
          ...
          case 2:
            ...
            indices.push.apply(
              ...
              __spreadArray$1(
                [],
                __read$1(HeapAsync.getChildrenIndexOf(i)),
                false
              )
            );
            return [3 /*break*/, 6];
            ...
            for (i = branch; i < n; ++i) {
              indices.push.apply(
                ...
                __spreadArray$1(
                  [],
                  __read$1(
                    HeapAsync.getChildrenIndexOf(i).filter(function (l) {
...
var Heap = /** @class */ (function () {
  ...
  Heap.prototype.addAll = function (elements) {
    ...
    (_a = this.heapArray).push.apply(
      _a,
      __spreadArray([], __read(elements), false)
    );
  ...
  Heap.prototype.contains = function (o, callbackFn) {
    if (callbackFn === void 0) {
      callbackFn = Heap.defaultIsEqual;
    }
    ...
    while (currentIndex < this.heapArray.length) {
      ...
      if (callbackFn(currentElement, element)) {
        ...
        indexes.push.apply(
          ...
          __spreadArray(
            [],
            __read(Heap.getChildrenIndexOf(currentIndex)),
            false
          )
        );
      }
  ...
  Heap.prototype._sortNodeDown = function (i) {
    ...
    var getPotentialParent = function (best, j) {
      if (
        ...
        _this.compare(_this.heapArray[j], _this.heapArray[best]) < 0
      ) {
        best = j;
      }
      return best;
    ...
    while (moveIt) {
      ...
      var bestChildIndex = childrenIdx.reduce(
        getPotentialParent,
        childrenIdx[0]
      );
    ...
    while (indices.length) {
      ...
      if (i < arr.length) {
        if (topHeap.length < n) {
          ...
          indices.push.apply(
            indices,
            __spreadArray([], __read(Heap.getChildrenIndexOf(i)), false)
          );
    ...
    for (var i = branch; i < n; ++i) {
      indices.push.apply(
        ...
        __spreadArray(
          [],
          __read(
            Heap.getChildrenIndexOf(i).filter(function (l) {
              return l < heapArray.length;
            })
          ),
          false
